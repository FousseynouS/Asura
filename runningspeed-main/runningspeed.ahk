...
Gui, Add, Text, x10 y10 w200 h30, Vitesse Treadmils
...
Gui, Show, x245 y700 w300 h115, RunningSpeed
...
if (ScriptActive) {
    ...
    Loop,
        ...
        If ErrorLevel = 0
        {
            ...
            Click
            ToolTip "Searching..."
            ImageSearch,imagex, imagey, 335, 315, 485, 335, *100 %A_ScriptDir%\bin\speed.png
            if ErrorLevel = 0
                {				
                    Sleep, 50
